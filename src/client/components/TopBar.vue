...
<template>
    <nav
        class="bg-white border-gray-200 dark:bg-gray-900 navbar navbar-expand-sm bg-primary mb-5 vert-border-black border-top-0">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item"><a class="nav-link active text-black" href="https://blog.sparklet.org/">Cafe</a>
            </li>
            <li class="nav-item"><a class="nav-link active text-black" href="https://pond.sparklet.org/">Pond</a>
            </li>
        </ul>
